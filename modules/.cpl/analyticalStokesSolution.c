...
void analyticalStokesSolution_2stokesSolution(char *RESULT_,struct DNS_ dns_,struct RIBLETS_ *riblet_,const int coordinates_l,const int coordinates_h,const ssize_t coordinates_i,char *coordinates__){{struct freefunc* es=freestack;
		...
		char xe_[(ssize_t)sizeof(double)*(/*SA1*/(1+1+1+1-1)+1)];
  double phi_	;
...
struct COMPLEX_ _9;
struct COMPLEX_ _10;
char _11[(ssize_t)sizeof(double)*(/*SA7*/(1+1+1-1)+1)];
dzz_=(*(double *)(dns_.zd_.i+dns_.zd_.a))-(*(double *)(dns_.zd_.a));riblets_9findEdge(riblet_ ,dns_ ,coordinates_l,coordinates_h,coordinates_i,coordinates__ ,xe_);
		 phi_= (*(double *)((*riblet_).phiC_))*pow((*(double *)(3*(ssize_t)sizeof(double)+xe_)),6)+(*(double *)((ssize_t)sizeof(double)+(*riblet_).phiC_))*pow((*(double *)(3*(ssize_t)sizeof(double)+xe_)),5)+(*(double *)(2*(ssize_t)sizeof(double)+(*riblet_).phiC_))*pow((*(double *)(3*(ssize_t)sizeof(double)+xe_)),4)+(*(double *)(3*(ssize_t)sizeof(double)+(*riblet_).phiC_))*pow((*(double *)(3*(ssize_t)sizeof(double)+xe_)),3)+(*(double *)(4*(ssize_t)sizeof(double)+(*riblet_).phiC_))*((*(double *)(3*(ssize_t)sizeof(double)+xe_))*(*(double *)(3*(ssize_t)sizeof(double)+xe_)))+(*(double *)(5*(ssize_t)sizeof(double)+(*riblet_).phiC_))*(*(double *)(3*(ssize_t)sizeof(double)+xe_))+(*(double *)(6*(ssize_t)sizeof(double)+(*riblet_).phiC_)); phi_w_= (3.14159265358979323846) - 0.5*phi_; laplExp_= (3.14159265358979323846)/(2.*phi_w_); g_= (*(double *)((*riblet_).gC_))*pow(phi_,6)+(*(double *)((ssize_t)sizeof(double)+(*riblet_).gC_))*pow(phi_,5)+(*(double *)(2*(ssize_t)sizeof(double)+(*riblet_).gC_))*pow(phi_,4)+(*(double *)(3*(ssize_t)sizeof(double)+(*riblet_).gC_))*pow(phi_,3)+(*(double *)(4*(ssize_t)sizeof(double)+(*riblet_).gC_))*(phi_*phi_)+(*(double *)(5*(ssize_t)sizeof(double)+(*riblet_).gC_))*phi_+(*(double *)(6*(ssize_t)sizeof(double)+(*riblet_).gC_)); D3_=  - cos((g_+1.)*phi_w_)/cos((g_-1.)*phi_w_); r_= sqrt((((*(double *)(coordinates_l*coordinates_i+coordinates__)) - (*(double *)(xe_)))*((*(double *)(coordinates_l*coordinates_i+coordinates__)) - (*(double *)(xe_))))+ (((*(double *)((1+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)((ssize_t)sizeof(double)+xe_)))*((*(double *)((1+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)((ssize_t)sizeof(double)+xe_))))+ (((*(double *)((2+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)(2*(ssize_t)sizeof(double)+xe_)))*((*(double *)((2+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)(2*(ssize_t)sizeof(double)+xe_))))); rPres_= ( r_ <dzz_  ?r_*pow(dzz_,(g_-2.) ) :pow(r_,(g_-1.))); theta_= atan2((*(double *)((1+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)((ssize_t)sizeof(double)+xe_)) ,(*(double *)((2+coordinates_l)*coordinates_i+coordinates__))-(*(double *)(2*(ssize_t)sizeof(double)+xe_))); thetaPres_= ( theta_>phi_w_  ?phi_w_/(phi_w_-(3.14159265358979323846))*(theta_-(3.14159265358979323846))  :( theta_< - phi_w_  ?phi_w_/(phi_w_-(3.14159265358979323846))*(theta_+(3.14159265358979323846))  :theta_));_4r=fabs((*(double *)((1+coordinates_l)*coordinates_i+coordinates__)) - (*(double *)((ssize_t)sizeof(double)+xe_)));_6r_5zvar=(*(double*)((2+coordinates_l)*coordinates_i+coordinates__));_7i_5zvar=_4r;/*zvar=_6r_5zvar,_7i_5zvar*/
		/*RESULT.u = r^laplExp*COS[laplExp*theta] */
		complex_8POWER(&_8,(_6r_5zvar-(*(double*)(2*(ssize_t)sizeof(double)+xe_))),(_7i_5zvar),laplExp_,0.);complex_8POWER(&_9,(_6r_5zvar+(*(double*)(2*(ssize_t)sizeof(double)+xe_))*laplExp_/(1.-laplExp_)),(_7i_5zvar),(1.-laplExp_),0.);complex_8POWER(&_10,(_6r_5zvar+(*(double*)(2*(ssize_t)sizeof(double)+xe_))*laplExp_/(1.-laplExp_)),(_7i_5zvar),(1.-laplExp_),0.); (*(double *)(0+RESULT_) )= ((_8.REAL_*_10.REAL_-_8.IMAG_*_10.IMAG_))			/* Laplace solution for streamwise velocity component (finite edge) */;
		 (*(double *)(0+(ssize_t)sizeof(double)+RESULT_) )= pow(r_,g_)*((g_+1.+D3_)*cos(g_*theta_) + g_*D3_*cos((g_-2.)*theta_))						/* Stokes solution for spanwise velocity component */;
		 (*(double *)(0+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+RESULT_) )= pow(r_,g_)*((g_+1.-D3_)*sin(g_*theta_) + g_*D3_*sin((g_-2.)*theta_))						/* Stokes solution for wall-normal velocity component */;
		 (*(double *)(0+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+RESULT_) )= D3_*4.*g_*rPres_*sin((g_-1.)*thetaPres_)								/* Stokes solution for pressure */;
		riblets_8edge(_11,(*riblet_),coordinates_l,coordinates_h,coordinates_i,coordinates__); (*(double *)(0+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+(ssize_t)sizeof(double)+RESULT_) )= 1.-fabs(1.-fabs(((*(double *)(coordinates_i+coordinates__))-(*(double *)(0+(ssize_t)sizeof(double)+_11)))-0.5*(*riblet_).s_)*2./(*riblet_).s_)	/* To account for periodic bc (for w) */;
	}}
