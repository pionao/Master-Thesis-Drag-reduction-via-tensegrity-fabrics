...
void grid_8initialiseGrid(struct GRID_ *this_,struct DNS_ dns_,const int di_l,const int di_h,const ssize_t di_i,char *di__){{struct freefunc* es=freestack;
...
_10_=di_l*di_i+di__; {char *_9_=(*this_).di_;int _9_1=/*SA3*/(1+1+1-1); do{{ (*(int *)(_9_))=(*(int *)(_10_)); _10_ =di_i+_10_;}_9_+=(ssize_t)sizeof(int);_9_1--;}while(_9_1>=0);}} 
		 (*(struct arrptr*)((*this_).xd_)).l=dns_.xd_.l;(*(struct arrptr*)((*this_).xd_)).h=dns_.xd_.h;(*(struct arrptr*)((*this_).xd_)).i=dns_.xd_.i;(*(struct arrptr*)((*this_).xd_)).a=dns_.xd_.a;
		 (*(struct arrptr*)((ssize_t)sizeof(struct arrptr)+(*this_).xd_)).l=dns_.yd_.l;(*(struct arrptr*)((ssize_t)sizeof(struct arrptr)+(*this_).xd_)).h=dns_.yd_.h;(*(struct arrptr*)((ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i=dns_.yd_.i;(*(struct arrptr*)((ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a=dns_.yd_.a;
		 (*(struct arrptr*)(2*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).l=dns_.zd_.l;(*(struct arrptr*)(2*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).h=dns_.zd_.h;(*(struct arrptr*)(2*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i=dns_.zd_.i;(*(struct arrptr*)(2*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a=dns_.zd_.a;
		 for(int iC_=  0 ;iC_<= 2;iC_+=1){
			int _11l;
int _12h;
ssize_t _13i;
char *_14;
...
ssize_t _21st;
ssize_t _22st;
 (*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).l=(2==0?INT_MIN:((*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).l-(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_)))/2);(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).h=(2==0?INT_MAX:((*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).h-(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_)))/2);(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).i=(2*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i);(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).a=(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_))*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a;
			_11l=(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).l+1;_12h=(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).h-1;_13i=(ssize_t)sizeof(double)*(1-(-1)+1)*(_12h-_11l+1);_15st=(-1)*(ssize_t)sizeof(double);_16st=_11l*(ssize_t)sizeof(double)*(1-(-1)+1)+_15st;
_14=malloc(_13i);if(_14==NULL)_14=errmalloc();_14-=_16st; (*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).l=_11l;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).h=_12h;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i=(ssize_t)sizeof(double)*(1-(-1)+1);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.l=(-1);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.h=1;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.i=(ssize_t)sizeof(double);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a=_14;
			_17l=(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).l+1;_18h=(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).h-1;_19i=(ssize_t)sizeof(double)*(1-(-1)+1)*(_18h-_17l+1);_21st=(-1)*(ssize_t)sizeof(double);_22st=_17l*(ssize_t)sizeof(double)*(1-(-1)+1)+_21st;
_20=malloc(_19i);if(_20==NULL)_20=errmalloc();_20-=_22st; (*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).l=_17l;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).h=_18h;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).i=(ssize_t)sizeof(double)*(1-(-1)+1);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.l=(-1);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.h=1;(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.i=(ssize_t)sizeof(double);(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.a=_20;
			 {int i_=  (*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).l ;do{{ 				
				 (*(double *)(-(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a) )= (*(double *)(i_*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).a))-(*(double *)((i_-1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).a));

				 (*(double *)(i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a) )= 0.;
				 (*(double *)((*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a) )= (*(double *)((i_+1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).a))-(*(double *)(i_*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).x_)).a));
				 (*(double *)(-(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.a) )= 1./(*(double *)(-(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a))/((*(double *)((2*i_+(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_))+1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a))-(*(double *)((2*i_+(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_))-1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a)));
				 (*(double *)(i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.a) )= 0.;
				 (*(double *)((*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+(GRID_s+grid_7i)+(char*)(this_))).a.a) )= 1./(*(double *)((*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.i+i_*(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).i+(*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).a.a))/((*(double *)((2*i_+(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_))+1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a))-(*(double *)((2*i_+(*(int*)(iC_*(ssize_t)sizeof(int)+(*this_).di_))-1)*(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).i+(*(struct arrptr*)(iC_*(ssize_t)sizeof(struct arrptr)+(*this_).xd_)).a)));
			}i_+=1;}while(i_<= (*(struct grid_s6*)(iC_*(ssize_t)sizeof(struct grid_s4)+GRID_s+(char*)(this_))).h                       );}
		}
	}} 
