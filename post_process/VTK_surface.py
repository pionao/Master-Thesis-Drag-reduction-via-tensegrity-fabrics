...
folder_path = '/media/lorenzo/Hard Disk 2/output_codice_tesi/output_turbolent_moving_wall_new_params_rms_0284/'

file_name = folder_path + 'tensegrity_parameters/par_int_arr.csv'
...
file_name = folder_path + 'tensegrity_parameters/par_real_arr.csv'
...
file_name = folder_path + "tensegrity_output/P_mat.csv"
P_mat = np.genfromtxt(file_name, delimiter=',', dtype='int')

file_name = folder_path + "tensegrity_output/P_mat_per.csv"
P_mat_per = np.genfromtxt(file_name, delimiter=',', dtype='int')

file_name = folder_path + "tensegrity_output/X_0.csv"
X_0 = np.genfromtxt(file_name, delimiter=',')

file_name = folder_path + "tensegrity_output/ghost_nodes.csv"
...
for i in range(n_max-n_min+1):
    ...
    for j in range(n_N):
        ten_sur_file.write(str(X_dot[3*j+1]) + " \n")
