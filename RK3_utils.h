...
SUBROUTINE K_i_compute(ARRAY(*) OF REAL K_i^; INTEGER n_q_tilde; INTEGER n_T_dof; REAL t; INTEGER n_N_dof; INTEGER n_N; INTEGER n_G; INTEGER n_T; INTEGER n_B; INTEGER nx; INTEGER ny; REAL l_per; REAL l_b; REAL sigma; REAL k; REAL I_0; ARRAY(*) OF REAL q_tilde; ARRAY(*) OF REAL X_0; ARRAY(*) OF REAL l_0; ARRAY(*,*) OF INTEGER T_con; ARRAY(*,*) OF INTEGER ghost_nodes)
    ...
    f_n_comp(f_n, n_N_dof, n_N, n_T, n_G, nx, ny, l_per, l_b, k, sigma, q_tilde, X_0, l_0, T_con, ghost_nodes)
